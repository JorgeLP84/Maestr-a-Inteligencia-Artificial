...
Al correr las notebooks pudimos ver que el agregar dos capas adicionales no generó una mejora en el aprendizaje, en el notebook original NumPy, el error disminuye aproximadamente de 0.67 a 0.05 después de 500 épocas y se tuvo que la curva dió una reducción fuerte al inicio, un breve estancamiento y continúa disminuyendo, lo que nos indica que la red sigue aprendiendo durante el entrenamiento. Ahora bien, en el notebook modificado, al agregar las dos capas, el error comienza alrededor de 0.76 y termina en .41, baja rápidamente hasta aproximadamente, se estanca bastantes epocas y después vuelve a disminuir en lass demás épocas.

Con Keras se observa un comportamiento similar. La arquitectura 4×3×3 reduce el loss de 0.2555 en la primera época a 0.2042 en la época 500, mostrando un buen aprendizaje. En la arquitectura más profunda, 4×3×3×3×3, el loss pasa de 0.2440 a 0.2220, por lo que podemos decir que se quedó estancado. 

Las curvas de NumPy y Keras presentan una tendencia general similar y es que la arquitectura más sencilla consigue aprender mejor que la arquitectura más profunda. Sin embargo, los valores exactos de error no son iguales. Esto es esperable porque las implementaciones pueden tener diferencias en la inicialización aleatoria de los pesos, el orden de los datos, la forma en que se realizan las actualizaciones de los pesos, el tamaño de los lotes, la tasa de aprendizaje entre otras cosas. 
...
**4.- Se anexan imágenes de correr los Colab**
